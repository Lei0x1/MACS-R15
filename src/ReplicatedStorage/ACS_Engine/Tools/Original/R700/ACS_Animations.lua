...
self.TacticalReloadAnim = function(objs)
	...
	TS:Create(objs[1], TweenInfo.new(.2,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.25,-0.2,.75) * CFrame.Angles(math.rad(120),math.rad(0),math.rad(0))):inverse() }):Play()
	wait(.2)

	TS:Create(objs[1], TweenInfo.new(.2,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.25,-0.5,.5) * CFrame.Angles(math.rad(175),math.rad(0),math.rad(0))):inverse() }):Play()
