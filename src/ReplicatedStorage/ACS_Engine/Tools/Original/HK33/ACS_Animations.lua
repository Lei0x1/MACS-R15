...
self.LArmCFrame 	= CFrame.new(-.6,-0.15,-.25) * CFrame.Angles(math.rad(110),math.rad(15),math.rad(15))
...
self.TacticalReloadAnim = function(objs)
	...
	TS:Create(objs[2], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(-.65,0.1,-0.5) * CFrame.Angles(math.rad(90),math.rad(60),math.rad(30))):inverse() }):Play()
	wait(.25)
	objs[4].Bolt.SlidePull:Play()
	TS:Create(objs[4].Handle.Slide, TweenInfo.new(.15,Enum.EasingStyle.Sine), {C0 =  CFrame.new(0,0,-0.4):inverse() }):Play()
	TS:Create(objs[4].Handle.Bolt, TweenInfo.new(.15,Enum.EasingStyle.Sine), {C0 =  CFrame.new(0,0,-0.7):inverse() }):Play()
	...
	TS:Create(objs[2], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(-.55,0.15,.3) * CFrame.Angles(math.rad(160),math.rad(0),math.rad(15))):inverse() }):Play()
	wait(.25)
	TS:Create(objs[2], TweenInfo.new(.25,Enum.EasingStyle.Back), {C1 = (CFrame.new(-.6,-0.15,.3) * CFrame.Angles(math.rad(70),math.rad(-15),math.rad(15))):inverse() }):Play()
	wait(.05)
	...
	TS:Create(objs[1], TweenInfo.new(.15,Enum.EasingStyle.Back), {C1 = (CFrame.new(0.05,-0.15,1) * CFrame.Angles(math.rad(85),math.rad(0),math.rad(0))):inverse() }):Play()
	wait(.25)
end;
...
self.JammedAnim = function(objs)
	...
	TS:Create(objs[4].Handle.Bolt, TweenInfo.new(.25,Enum.EasingStyle.Sine), {C0 =  CFrame.new(0,0,-0.7):inverse() }):Play()
