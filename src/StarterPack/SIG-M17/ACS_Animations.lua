...
self.MainCFrame 	= CFrame.new(0.5,-0.7,-0.15)
...
self.RArmCFrame 	= CFrame.new(0,-0.15,0) * CFrame.Angles(math.rad(90),math.rad(10),math.rad(0))
...
self.SprintAnim = function(objs)
	TS:Create(objs[1],TweenInfo.new(.25,Enum.EasingStyle.Sine),{C1 = (CFrame.new(0,-0.15,0.1) * CFrame.Angles(math.rad(60), math.rad(0), math.rad(-5))):inverse() }):Play()
	TS:Create(objs[2],TweenInfo.new(.25,Enum.EasingStyle.Sine),{C1 = (CFrame.new(-.55,-0.45,0) * CFrame.Angles(math.rad(65),math.rad(25),math.rad(15))):inverse() }):Play()
	wait(0.25)
end;

self.ReloadAnim = function(objs)
	TS:Create(objs[1], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0,-0.15,0) * CFrame.Angles(math.rad(90),math.rad(-25),math.rad(-10))):inverse() }):Play()
	...
	TS:Create(objs[1], TweenInfo.new(.5,Enum.EasingStyle.Back), {C1 = (CFrame.new(0,-0.15,0) * CFrame.Angles(math.rad(85),math.rad(-15),math.rad(-10))):inverse() }):Play()
	...
	TS:Create(objs[1], TweenInfo.new(.15,Enum.EasingStyle.Back), {C1 = (CFrame.new(0,-0.15,0) * CFrame.Angles(math.rad(90),math.rad(-25),math.rad(-10))):inverse() }):Play()
...
self.TacticalReloadAnim = function(objs)
	...
	TS:Create(objs[1], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0.3,-0.15,0) * CFrame.Angles(math.rad(120),math.rad(5),math.rad(-5))):inverse() }):Play()
	...
	wait(.2)
	TS:Create(objs[1], TweenInfo.new(.3,Enum.EasingStyle.Back), {C1 = (CFrame.new(0.3,-0.15,0) * CFrame.Angles(math.rad(70),math.rad(-5),math.rad(-5))):inverse() }):Play()
	...
	objs[4].Handle.AimUp:Play()
	--wait(.25)
	TS:Create(objs[1], TweenInfo.new(.15,Enum.EasingStyle.Sine), {C1 = (CFrame.new(0,-0.15,0) * CFrame.Angles(math.rad(100),math.rad(-20),math.rad(0))):inverse() }):Play()
	TS:Create(objs[2], TweenInfo.new(.25,Enum.EasingStyle.Sine), {C1 = (CFrame.new(-.6,-0.3,0) * CFrame.Angles(math.rad(60),math.rad(50),math.rad(30))):inverse() }):Play()
	wait(.25)
	objs[4].Handle.MagIn:Play()
	TS:Create(objs[1], TweenInfo.new(.25,Enum.EasingStyle.Back), {C1 = (CFrame.new(0,-0.15,0) * CFrame.Angles(math.rad(110),math.rad(-20),math.rad(0))):inverse() }):Play()
	wait(0.25)
